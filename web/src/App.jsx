                            ...
                            <div className="max-w-xl mx-auto p-6">
                                ...
                                <div className="mb-4">
                                    {!token ? (
                                        <form onSubmit={e => {
                                            ...
                                            <input name="uuid" placeholder="Enter magic UUID"
                                                   className="p-2 border mr-2 w-2/3"/>
                                            <button type="submit"
                                                    className="bg-blue-600 text-white px-4 py-2 rounded">Login
                                            </button>
                                        </form>
                                    ) : (
                                        <div className="flex justify-between items-center">
                                            <span className="text-green-600">✅ Logged in</span>
                                            <button className="text-sm text-red-600 underline ml-4"
                                ...
                                {token && (
                                    <form onSubmit={addBook} className="space-y-3 mb-6">
                                        <input className="w-full p-2 border rounded" placeholder="Title" name="title"
                                               value={form.title} onChange={handleInput} required/>
                                        <input className="w-full p-2 border rounded" placeholder="Author" name="author"
                                               value={form.author} onChange={handleInput}/>
                                        <input className="w-full p-2 border rounded" placeholder="Instrument"
                                               name="instrument" value={form.instrument} onChange={handleInput}/>
                                        <input className="w-full p-2 border rounded" placeholder="Condition"
                                               name="condition" value={form.condition} onChange={handleInput}/>
                                        <label className="flex items-center space-x-2">
                                            <input type="checkbox" name="public" checked={form.public}
                                            ...
                                            <div>
                                                ...
                                                {token && (
                                                    ...
                                                    >
                                                        {book.public ? (
                                                            <span
                                                                className="text-green-600 font-semibold">🌍 Public</span>
                                                        ) : (
                                                            <span
                                                                className="text-red-600 font-semibold">🔒 Private</span>
                                                        )}
                                                    </div>
                                                )}
                                            </div>
